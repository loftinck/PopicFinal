...
import DeleteFriendsGridTile from "../components/DeleteFriendsGridTile";
...
const topList = () => {
    return ( 
        <View style={{marginLeft: 5}}>
            <Text style={{fontWeight: 'bold', fontSize: 15, marginTop: 20}}>  Liste d'amis </Text>
        </View>
...
function Deletefriend() {
    ...
    function renderAddFriendsItem(itemData){
        return <DeleteFriendsGridTile pp={itemData.item.pp} username={itemData.item.username}/>}
